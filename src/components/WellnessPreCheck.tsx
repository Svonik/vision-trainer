...
export function WellnessPreCheck({
    onSelect,
    onSkipSession,
}: WellnessPreCheckProps) {
            ...
            <div className="bg-[var(--surface)] rounded-2xl p-8 max-w-sm mx-4 flex flex-col items-center gap-6">
                ...
                <div className="flex gap-4">
                    <button
                        ...
                        aria-label="Чувствую себя хорошо"
                        className="text-4xl p-4 rounded-2xl border-2 border-[var(--border)] bg-[var(--surface)] hover:border-[var(--accent)] btn-press transition-[transform,box-shadow,border-color]"
                    >
                        &#x1F60A;
                    </button>
                    <button
                        ...
                        aria-label="Чувствую себя нормально"
                        className="text-4xl p-4 rounded-2xl border-2 border-[var(--border)] bg-[var(--surface)] hover:border-[var(--accent)] btn-press transition-[transform,box-shadow,border-color]"
                    >
                        &#x1F610;
                    </button>
                    <button
                        ...
                        aria-label="Чувствую себя плохо"
                        className="text-4xl p-4 rounded-2xl border-2 border-[var(--border)] bg-[var(--surface)] hover:border-[var(--accent)] btn-press transition-[transform,box-shadow,border-color]"
                    >
                        &#x1F61F;
                    </button>

...
export function computeWeeklySchedule(sessions: readonly SessionResult[]): WeeklySchedule {
...
export function getCourseProgress(schedule: WeeklySchedule, courseWeeks: number): number {

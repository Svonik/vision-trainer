...
export function advanceContrast(
    state: SuppressionTestState,
): SuppressionTestState {
    return {
        ...state,
        currentContrast: Math.min(state.currentContrast + state.step, 100),
    };
}
...
export function recordResponse(
    ...
    return {
        ...
        responses: [
            ...state.responses,
            { contrast: state.currentContrast, seen: seenBoth },
        ],
    };
}

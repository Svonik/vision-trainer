    ...
    return (
        ...
        >
            <div className="bg-[var(--surface)] border border-[var(--border)]/50 rounded-3xl shadow-lg shadow-purple-900/20 p-8 max-w-md w-full text-center spring-enter">
                ...
                <h2 className="font-[var(--font-display)] text-xl text-[var(--text)] mb-2">Панель врача</h2>
                <p className="text-[var(--text-secondary)]">В разработке. Здесь будет панель управления для врача с графиками прогресса пациентов.</p>
            </div>
        </div>
    );
}
